...
export default function Filters({ onFilterChange, setPage, openCreateModal }) {
  ...
  // Aplica los filtros al hacer click (estilo MitigationFilters)
  const applyFilters = () => {
    // Usa el handler onFilterChange similar a MitigationFilters
  ...
  return (
    <div className="bg-slate-800/50 backdrop-blur border border-slate-700/50 rounded-2xl p-6 mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        {/* Botón aplicar filtros (en la misma línea del grid) */}
        <div>
          <button
            onClick={applyFilters}
            className="from-cyan-600 to-blue-600 hover:from-cyan-700 hover:to-blue-700 bg-gradient-to-r text-white font-semibold py-3 px-6 rounded-xl shadow-lg hover:shadow-xl transition-all w-full"
          >
            Filtrar
          </button>
        </div>
